...
if __name__ == "__main__":
    ...
    while((MainMenuChoice < 1) or (MainMenuChoice > 3)):      # loop of the main menu
        ...
        # user chooses his next move in main menu (start, help, end)
        MainMenuChoice = Menu(1, 3, 101)

        # Start
        match MainMenuChoice:
            case 1:
                # variable of the players menu; holds the number of player slot that was choosen throughout the game
                choicePlayer = 0
