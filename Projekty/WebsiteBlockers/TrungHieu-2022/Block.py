...
Label(root, text ='WEBSITE BLOCKER' ,justify=CENTER,fg="red", font ='Arial').pack()
...
Label(root, text ='Unblock Website :' , font ='arial 13 bold').place(x=5 ,y=190)
WebsitesUn = Text(root,font = 'arial 10',height='2', width = '40', wrap = WORD, padx=5, pady=5)
WebsitesUn.place(x= 160,y = 190)
...
def UnBlocker():
    ...
    with open ("C:\Windows\System32\drivers\etc\hosts",'r+') as host_fileUn:
...
#nut click chan
Button(root, text = 'Block',font = 'arial 12 bold',pady = 5,command = Blocker ,width = 6, bg = 'royal blue1', activebackground = 'sky blue').place(x = 200, y = 110)

#nut click remove chan
Button(root, text = 'UnBlock',font = 'arial 12 bold',pady = 5,command = UnBlocker ,width = 6, bg = 'royal blue1', activebackground = 'sky blue').place(x = 200, y = 240)
