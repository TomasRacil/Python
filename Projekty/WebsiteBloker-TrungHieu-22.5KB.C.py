...
Label(root, text ='WEBSITE BLOCKER' ,justify=CENTER,fg="red", font ='arial 15 bold').pack()
...
#nut click chan
Button(root, text = 'Block',font = 'arial 12 bold',pady = 5,command = Blocker ,width = 6, bg = 'royal blue1', activebackground = 'red').place(x = 200, y = 110)

#nut click remove chan
Button(root, text = 'UnBlock',font = 'arial 12 bold',pady = 5,command = UnBlocker ,width = 6, bg = 'royal blue1', activebackground = 'red').place(x = 200, y = 240)
