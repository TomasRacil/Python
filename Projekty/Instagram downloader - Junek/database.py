def databasecreate():
    ...
    try:
        ...
        my_cursor.execute("CREATE TABLE posts (ID INTEGER AUTO_INCREMENT PRIMARY KEY, id_post VARCHAR(255), posted_by VARCHAR(255), display_url VARCHAR(1024), edge_liked_by INTEGER, popisek VARCHAR(1024))")
