...
1. vygenerovat si vlastní API_KEYS na https://testnet.binancefuture.com/ (PUBLIC a SECRET KEY)
...
6. pip install TA_Lib-0.4.22-cp37-cp37m-win_amd64.whl (nebo jiný wheel vhodný pro vás)
