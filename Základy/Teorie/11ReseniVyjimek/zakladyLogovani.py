...
#Pro definování úrovně zpráv které chcete zaznamenávat slouží klíčové slovo level
...
#Pro zaznamenání vznikle událost použijeme jednu z pětimetod podle typu předávané zprávy
...
#Pokud chceme zachytit celou chybovou událost používáme metodu exception která zachytí událost a přiřadí jí úroveň error 
a = 5
b = 0
