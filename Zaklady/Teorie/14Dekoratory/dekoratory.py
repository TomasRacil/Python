"""
Dekorátory jsou funkce, které zabalí jinou funkci a tím jsou schopné ovlivnit její vstup nebo výstup, nebo jestli bude vůbec zavolána,
#aniž bychom přímo modifikovali samotnou funkci.
Tato vlastnost může být velice užitečná například v případě že nemáme možnost funkci modifikovat, nechceme ji modifikovat, nebo chceme dekorovat více funkcí.
"""
#výchozí funkce 
...
#Na základě těchto dvou principů (předávání funkcí a volání funkcí uvnitř funkcí) fungují dekorátory
...
rekniAhoj = jednoduchyDekorator(rekniAhoj)
...
#Pokročilý dekorátor
#U pokročilého dekorátoru využijeme functools, které zabrání, aby se naše funkce vydávala za něco jiného než je.
import functools
...
#Závěrem bych ještě chtěl zmínit, že dekorátory můžeme uplatňovat uplně stejně i na metody