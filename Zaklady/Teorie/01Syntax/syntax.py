...
#Narozdíl od mnoha ostatních jazyků není nutné řádky ukončovat nějakým symbolem stačí jednoduše začít psát na další řádek.
print("první řádek kódu")
print("druhý řádek kódu")

#Pokud by z nějákého důvodu bylo nutné zapsat dva příkazy na jeden řádek je to možné za použití symbolu ;
...
#Dalším klíčovým prvkem syntaxu tohoto jazyka je odsazení a symbol dvojtečky. 
...
#Zde předvedeno na jednoduché if podmínce, ale funguje stejným způsobem při definici funkcí, tříd, cyklů a dalších jim podobným prvkům.
if True:
	print("Odsazenný blok uvnitř if")
print("Neodsazený blok mimo if")

#V případě že má blok kódu jen jeden řádek je možné ho psát přímo za dvojtečku.
if True: print("Blok přímo za : ")
print("Blok mimo podmínku")

#Důležité je taky si v tomto jazyce dávat pozor na velké a malé znaky, neboť python mezi nimi rozlišuje.
print("Toto funguje")
