...
class Vehicle:
    ...
    def info(self):
        print(f'Auto je na místě {self.x} a má průměrnou rychlost {self.avgSpeed} auto na jednu nadrz uraazi {self.fuelCapacity/self.avgFuelConsumption*100}')
...
class Route:
    ...
    def cenaVsech(self, cenaNafty, cenaBenzinu):
        ...
        celkem = self.spotrebaVsech()[0] * cenaNafty + \
            self.spotrebaVsech()[1] * cenaBenzinu
        return celkem
